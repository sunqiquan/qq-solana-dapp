...
(()=>{
    const e = new Error("Cannot find module '@/voting_program/types/voting_program.json'");
        ...
        mutationFn: async (input)=>{
            try {
                ...
                const ix = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gill$2f$dist$2f$programs$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getAddMemoInstruction"])({
                    ...
                    data: Buffer.concat([
                        Buffer.from(idl.instructions.find((i)=>i.name === 'vote').discriminator),
                        new BN(input.pollId).toArrayLike(Buffer, 'le', 8),
                        (()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c6180843._.js.map