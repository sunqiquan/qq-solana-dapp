...
function useVoteMutation({ address }) {
    const { client } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wallet$2d$ui$2f$react$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useWalletUi"])();
    const signer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$solana$2f$use$2d$wallet$2d$ui$2d$signer$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useWalletUiSigner"])();
    const PROGRAM_ID = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PublicKey"](idl.address);
    const invalidateBalanceQuery = useInvalidateGetBalanceQuery({
        address
    });
    const invalidateSignaturesQuery = useInvalidateGetSignaturesQuery({
        ...
        mutationFn: async (input)=>{
            try {
                ...
                const ix = {
                    ...
                    data: Buffer.concat([
                        (()=>{
                            const voteInstruction = idl.instructions.find((i)=>i.name === 'vote');
                            if (!voteInstruction) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b32ddf13._.js.map