...
"[project]/src/components/journal/journal-feature-index.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AccountFeatureIndex(param) {
    ...
    if (account) {
        return redirect("/journal/".concat(account.address.toString()));
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$journal$2f$journal$2d$feature$2d$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/journal/journal-feature-index.tsx [app-client] (ecmascript)");
'use client';
;
;
;
...
//# sourceMappingURL=src_aac3404f._.js.map